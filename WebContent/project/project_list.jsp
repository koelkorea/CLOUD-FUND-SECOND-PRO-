  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <form action = "/HAO/project/project.do" class="col-lg-3"  id = "searchFrm" name = "searchFrm" method = "get">
		...
		<h3 class="my-4 text-center"><strong>게시물 출력 단위</strong></h3>
		
		<div>
			<select name = "page_size" id = "page_size" class = "form-control input-sm text-center">
				<option value = "4" <% if(4 == param.getPageSize()){ out.print("selected");  } %>>4</option>
				<option value = "8" <% if(8 == param.getPageSize()){ out.print("selected");  } %>>8</option>
				<option value = "12" <% if(12 == param.getPageSize()){ out.print("selected");  } %>>12</option>
				<option value = "24" <% if(24 == param.getPageSize()){ out.print("selected");  } %>>24</option>
				<option value = "48" <% if(48 == param.getPageSize()){ out.print("selected");  } %>>48</option>
				<option value = "96" <% if(96 == param.getPageSize()){ out.print("selected");  } %>>96</option>
			</select>
		</div>
